...
function getValidUrls(url) {
    ...
    if (baseUrl !== baseUrlWithoutSlash) baseUrlVariations.push(baseUrl);else baseUrlVariations.push(`${baseUrlWithoutSlash}/`);
    ...
    async start(url) {
        ...
        try {
            ...
            if (this.tests.includes('WINDOW')) {
                nativeWindowsProperties = await (0, _windowProperties.getNativeWindowProperties)(this.page);
            }
